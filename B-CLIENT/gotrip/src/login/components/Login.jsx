                    ...
                    <div className="card-body login-card-body">
                        <div className="mt-3 ml-0 row justify-content-center input-group">
                            <div className="image col-4 p-0 mb-5">
                                <img src={avatar} width="100" height="100" className="img-circle " alt="User Image" />
                            </div>
                        </div>
                        ...
                        <form method="post">
                            <div className="input-group mb-4">
                                <input type="text"
                                    ...
                                    value={username}
                                    onChange={(event)=>this.onHandleUsernameChange(event)}
                                />
                                ...
                                <div className="col-12">
                                    <div className="icheck-primary">
                                        <input type="checkbox"
                                            id="remember"
                                            checked={rememberMe}
                                            onChange={this.onHandleRememberMeChange} />
