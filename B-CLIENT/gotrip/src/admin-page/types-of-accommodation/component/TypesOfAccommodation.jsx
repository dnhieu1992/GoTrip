...
const TypesOfAccommodation = () => {
    ...
    const onHandleSearch = () => {
        const result = mockDatas.filter(item => {
            if(!typesOfAccommodationName || (typesOfAccommodationName && item.name.toLowerCase().indexOf(typesOfAccommodationName.toLowerCase()) > -1 )) {
                return item;
            }
        });
        setData(result);
                ...
                <div className = "row">
                    <div className="col-sm-6">
                        <div className="form-group row">
                            ...
                            <input className = "form-control col-sm-8" value={typesOfAccommodationName} onChange={onHandleNameChange}/>
                        </div>
                    </div>
